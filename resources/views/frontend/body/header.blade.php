                            ...
                            <a data-height="60" data-padding="25"
                               ...
                               title="MADA Leasing">
                                <img alt="finance2"
                                     ...
                                     data-height="60"
                                     data-no-retina
                                     data-retina="{{asset('frontend/content/images/logo-yes.png')}}"
                                ...
                                <img alt="finance2"
                                     ...
                                     data-no-retina
                                     data-retina="{{asset('frontend/content/images/logo-yes.png')}}"
                                     src="{{asset('frontend/content/images/logo-yes.pn')}}g"/>
                                <img alt="finance2"
                        ...
                        <div class="menu_wrapper">
                            <nav id="menu">
                                <ul class="menu menu-main"
                                    ...
                                    <li>
                                        <a href="our-partners.html"><span>Our partners</span></a>
                                    </li>
                                    <li>
                    ...
                    <rs-slides>
                        <rs-slide
                            ...
                            <rs-layer data-color="#4d4d4d"
                                ...
                                If you have any questions, order a
                                free conversation with our
                                consultant
                            </rs-layer>
                            ...
                            <rs-layer data-color="#4d4d4d"
                                ...
                                Mada Financial Leasing is a
                                welcoming
                                firm that
                                encourages employees to communicate
                                and
                                support its customers and society.
                            </rs-layer>
