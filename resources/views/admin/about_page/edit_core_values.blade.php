                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div
                                            ...
                                            <h4 class="mb-sm-0">Edit Value</h4>
                                ...
                                <form action="{{ route('about.core-values.edit.update') }}" method="post"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control"
                                                   ...
                                                   id="value_image"
                                                   name="value_image"
                                                   placeholder="Services Header Image"
                                                   value=""
                                            >
                                        </div>
                                    </div>
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-sm-10">
                                            <img id="show_image" class="rounded avatar-lg" alt="200x200"
                                                 src="{{ !empty($core->image) ? url($core->image) : url('upload/780-780.png') }}"
